                                ...
                                <tbody>
                                    ...
                                    foreach ($table as $val) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo html_entity_decode(character_limiter($val->kritik, 100)); ?></td>
                                            ...
                                            <td><?php echo anchor('kritik/tanggapi-kritik/' . $val->id_kritik, '<i class="material-icons">forum</i><span>Tanggapi Kritik</span>', 'class="btn btn-info waves-effect waves-float"'); ?></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
