<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>KRITIK</h2><small>Masukan berupa kritik adalah sesuatu yang bersifat membangun.</small>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <?php echo anchor(
                            'kritik/kritik-add',
                            '<i class="material-icons">input</i><span>Tambah Kritik</span>',
                                ...
                                <tbody>
                                    <?php foreach ($table as $val) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo ucfirst(htmlspecialchars_decode(character_limiter($val->kritik, 200))); ?></td>
                                            <td>
