                        ...
                        <div class="row clearfix">
                            <?php if (!empty($gambar)) { ?>
                                <div class="col-md-3">
                                    ...
                                    <a href="<?php echo site_url('uploads/gambar-lowongan/' . $gambar); ?>" class="thumbnail">
                                        <?php echo img('uploads/gambar-lowongan/' . $gambar, 'class="img-responsive"') ?>
                                    </a>
                                </div>
                            <?php } ?>
                            <div class="col-md-9">
                                <p class="lead">
                                    <?php echo html_escape(ucfirst($job_title)); ?>
                                </p>
                                <hr>
                                <p>Batas waktu : <?php echo htmlspecialchars(indonesian_date($akhir_waktu), ENT_QUOTES, 'UTF-8'); ?></p>
